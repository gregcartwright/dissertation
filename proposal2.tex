...
was considered during the stay. The data collection tool that will be used is 
provided in %appendix~\ref{} ***should this be in research instrument section?***
...
section~\ref{sec:design}. For objective \ref{obj:prevalence} 
