...
the incedence of frailty syndromes(see appendix~\ref{apx:syndromes}). 
...
assesment tools their findings are likely to be more accurate however the 
...
%Look at Soong, 15 for examples of papers looking at hospital frailty.
...
% Try to find a referenc for this.
...
this, aruguing that whilst there are associations, the actual decision
...
Analysing the data was ther next hurdle. Despite being a Mathematics graduate
...
shortcuts with learning about stuff you don't understand.
