...
be suitable to this strategy (ref. the research book), and could involve 
...
decision makers \parencite{parahoo:14}.

Despite the positive aspects of a qualitative approach to addressing 
objective\ref{obj:association}, this plan may not consider the conept of frailty
...
that are employed. It was felt that to adopt such a tack would involve a 
...
random and non-random sampling. The setting for the study is group of 12 
...
Trust over over virtual private network (VPN).
...
Chi-squared requires expected frequeny in each cell to be at least 5 
