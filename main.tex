...
\textcite{martin:08} notes a pitfall of the phenotype systme is that it fails to
...
\textcite{martin:08} conclude that different measures of frailty are suited to
different purposes.
