...
Non-probabilistic sampling limits generalisability (reference)
...
and seasonal nature of the sample, limits generalisability
to the Trust, not just to the research community.
