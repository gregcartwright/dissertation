...
(12.7\%) had ACP during the hospital stay. The most common CFS score of patients 
...
with this CFS underwent ACP. Figure \ref{} shows tyhe number of patients who 
had an ACP for each CFS whereas figure \ref{} show this number as a percentage
of the total number for that CFS.
...
When frailty is grouped into mild moderate and severe 

Looking at level of frailty against whether or not ACP happens 
% Can I do a table showing all this together??

% Was the age distribution negatively skewed?
