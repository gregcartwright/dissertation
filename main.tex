...
The six patinets that had a pre-existing ACP on admission to CH 
...
Reaserch is required to explore the decision making around ACP in CH. The
...
\centering
\caption{Age histogram with normal distirbution curve}
\includegraphics[width=\textwidth,
