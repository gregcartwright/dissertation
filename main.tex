...
who had ACP during CH stay was CFS=7. 7 out of the 18 patients (38.9\%) that
underwent ACP in the CH had a CFS of 7. Also this represents 17.5\% of the 
patients with CFS=7. The CFS score which had the highest 
proportion of it's patients having ACP was CFS=8 where 3 out of the 4 patients 
with this CFS underwent ACP ($p=0.011$, see table~\ref{tab:statistics}).
