...
to understand what is meant by it. The overarching guidance for frailty in the 
UK is provided by the \textcite{bgs:14} who link frailty as a concept to the 
...
The definition they provide is wide: where ``multiple body systems gradually lose
their inbuilt reserves''. This does not explain the effect that frailty has upon
a person. A much earlier definition is provided by \textcite{fried:01}. They
...
The phenotype model puts people into categories: a person is either not frail,
pre-frail or frail. It does not allow for levels of frailty, lumping anyone with
frailty into one group. As frailty is a consquence of the relaitive failure of
multiple physiological systems it is clearly a dynamic state. It is moree complex
...
recognised this and proposed frailty is viewed as an accumulation of
...
%****** Critique this a bit and then look at CFS ***
