...
Frailty is a syndrome that has increasing incedence with age, leaving the person
...
% Discuss results in context of my objectives
The first part of objective~\ref{obj:prevalence} is to assess how frail the
local community hospital poipulation is. It was seen in 
section~\ref{sec:local-practice} that the primary reason for community 
hospital of many of the patients is for rehabillitation. Two implications from
...
% Should I put in some stats (Fishers) for this?
...
In this study both age and frailty were associated with increased incedence of
...
inevitable consequence of getting older, it's incedence does increase with age,
...
neuro, CVS and other all scored higher on this, but their overall numbers
were very small. Out of these, other neuro was the highest with 5 patients in 
...
symptoms that are actually sequealae to an underlying pathological process
that has manifested itself in this way bceause the person has frailty.
...
any association between the incedence of the individual frailty syndromes 
...
they are at a greater risk of adverse outcomes. Their physioloigcal reserves
...
bed. The frailty sydrome may well persists after this and due to this the
...
and therefore their frailty is likely to have been a more influencial factor
...
For a factor to influence whether somthing happens or not implies that there 
is a cause and effect relationship between the factor and the outcome. 
The effect has occured in the thought processes of the clinical team. To 
...
of the patients. The presenting complaint is in a factor that has 
necessetated a hospital admission, but there are often other underlying
factors contributing. How does this affect the influence that the intial
...
Very few patients with frailty have an ACP when they arrive at a commnity
...
this outweigh the benefits, causing unecessary distress and complications
