...
Whilst exploring avaiodable admissions to acute hospital \textcite{mytton:12} 
suggests that avoiding unecessary admission depends on good decision making at 
the time. This is difficult when the person assessing the patient does not them
or their history. If we can prompt more consideration of ACP then this should 
assist with informing the decision making process at the time of deterioration.
