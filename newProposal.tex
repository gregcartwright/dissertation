...
\item Assess the frailty of the Trust community hospital inpatient populatiob
...
The first of these is to assess whether there is a problem with 
To explore whether or not there is a percieved problem with severely frail patients having
acute admissions that could, on balance, be detrimental to the patient, it is proposed
that a questionnaire is used. This would be circulated to all qualified healthcare
